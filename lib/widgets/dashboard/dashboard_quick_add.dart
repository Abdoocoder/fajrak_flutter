  ...
  String _getCategoryName(String key) {
    switch (key) {
      case 'طعام':
        return 'cat_food'.tr();
      case 'مواصلات':
        return 'cat_transport'.tr();
      case 'فواتير':
        return 'cat_bills'.tr();
      case 'صحة':
        return 'cat_health'.tr();
      case 'ترفيه':
        return 'cat_entertainment'.tr();
      case 'تسوق':
        return 'cat_shopping'.tr();
      case 'راتب':
        return 'cat_salary'.tr();
      case 'عمل حر':
        return 'cat_freelance'.tr();
      case 'استثمار':
        return 'cat_investments'.tr();
      case 'مكافأة':
        return 'cat_gifts'.tr();
      case 'إيجار':
        return 'cat_rent'.tr();
      case 'اشتراكات':
        return 'cat_subs'.tr();
      case 'عناية':
        return 'cat_personal'.tr();
      case 'سفر':
        return 'cat_travel'.tr();
      case 'دين':
        return 'cat_debt_pay'.tr();
      default:
        return 'cat_others'.tr();
    }
  }
        ...
        children: [
          ...
          if (_selectedCurrency != widget.currency)
            Padding(
              ...
              child: Text(
                'Rate: ${_exchangeRate.toStringAsFixed(4)} | ≈ ${(double.tryParse(_amountController.text) ?? 0 * _exchangeRate).toStringAsFixed(2)} ${widget.currency}',
                style: TextStyle(
                  fontSize: 10,
                  color: widget.colorScheme.onSurfaceVariant.withValues(
                    alpha: 0.6,
