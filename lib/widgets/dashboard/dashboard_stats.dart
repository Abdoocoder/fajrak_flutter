      ...
      child: Column(
        children: [
          ...
          FittedBox(
            child: Text(
              (totalBalance < 0 ? '-' : '') +
                  totalBalance.abs().toStringAsFixed(0),
              style: TextStyle(
                color: balColor,
          ...
          Container(
            ...
            child: Column(
              children: [
                Text(
                  '${'dash_monthly'.tr()}: ${monthlyNet >= 0 ? '+' : '-'}${monthlyNet.abs().toStringAsFixed(0)}',
                  style: TextStyle(
                    color: monthlyNetColor,
                    fontSize: 11,
                ...
                if (hasCommitments) ...[
                  Text(
                    '${'dash_after_debts'.tr()}: ${netAfterDebts >= 0 ? '+' : '-'}${netAfterDebts.abs().toStringAsFixed(0)}',
                    style: TextStyle(
                      color: netAfterColor,
                      fontSize: 11,
                      fontWeight: FontWeight.w700,
