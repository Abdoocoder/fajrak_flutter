...
class _AddBudgetDialogState extends State<AddBudgetDialog> {
  ...
  void initState() {
    super.initState();
    _selectedCat =
        widget.existing?['category'] as String? ??
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            widget.existing != null ? 'budget_edit'.tr() : 'budget_new'.tr(),
            style: TextStyle(
              fontSize: 18,
            ...
            GridView.count(
              ...
              children: widget.localizedCategories.map((cat) {
                ...
                return GestureDetector(
                  onTap: () =>
                      setState(() => _selectedCat = cat['key'] as String),
                  child: Container(
                    decoration: BoxDecoration(
                      color: isSelected
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                widget.existing != null ? 'save'.tr() : 'add'.tr(),
